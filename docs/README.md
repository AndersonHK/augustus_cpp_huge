...
- [`hippodrome_racing_and_betting.md`](hippodrome_racing_and_betting.md): data-owned two-/four-team race lifecycle, declarative betting, graphics pipeline, and save compatibility.
