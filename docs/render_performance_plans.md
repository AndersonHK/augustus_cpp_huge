...
- Store authored logical sizes in a fine-grained integer or fixed-point unit rather than floats. The grain should make half-size, third-size, sixth-size, 2/3-size, and 6x source-to-logical ratios exact enough for deterministic layout and batching.
