...
typedef enum {
    ...
    TR_SAVEGAME_MOD_MISMATCH_TITLE,
    TR_SAVEGAME_MOD_MISMATCH_MESSAGE,
    ...
    TR_CITY_WARNING_ORIENTATION_NORTH,
    TR_CITY_WARNING_ORIENTATION_NORTHEAST,
    TR_CITY_WARNING_ORIENTATION_EAST,
    TR_CITY_WARNING_ORIENTATION_SOUTHEAST,
    TR_CITY_WARNING_ORIENTATION_SOUTH,
    TR_CITY_WARNING_ORIENTATION_SOUTHWEST,
    TR_CITY_WARNING_ORIENTATION_WEST,
    TR_CITY_WARNING_ORIENTATION_NORTHWEST,
    TR_CITY_WARNING_CLEAR_LAND_NEEDED,
    TR_CITY_WARNING_OUT_OF_MONEY,
    TR_CITY_WARNING_ONE_BUILDING_OF_TYPE,
    TR_CITY_WARNING_ROAD_ACCESS_NEEDED,
    TR_CITY_WARNING_NOT_AVAILABLE,
    TR_CITY_WARNING_NOT_AVAILABLE_YET,
    TR_CITY_WARNING_MARBLE_NEEDED_LARGE_TEMPLE,
    TR_CITY_WARNING_MARBLE_NEEDED_ORACLE,
    TR_CITY_WARNING_WORKERS_NEEDED,
    TR_CITY_WARNING_MORE_FOOD_NEEDED,
    TR_CITY_WARNING_BUILD_MARKET,
    TR_CITY_WARNING_MEADOW_NEEDED,
    TR_CITY_WARNING_WATER_NEEDED,
    TR_CITY_WARNING_ROCK_NEEDED,
    TR_CITY_WARNING_TREE_NEEDED,
    TR_CITY_WARNING_SHORE_NEEDED,
    TR_CITY_WARNING_OPEN_TRADE_TO_IMPORT,
    TR_CITY_WARNING_TRADE_IMPORT_RESOURCE,
    TR_CITY_WARNING_WATER_PIPE_ACCESS_NEEDED,
    TR_CITY_WARNING_PLACE_RESERVOIR_NEXT_TO_WATER,
    TR_CITY_WARNING_CONNECT_TO_RESERVOIR,
    TR_CITY_WARNING_SENTRIES_NEED_WALL,
    TR_CITY_WARNING_BUILD_BARRACKS,
    TR_CITY_WARNING_WEAPONS_NEEDED,
    TR_CITY_WARNING_BUILD_ACTOR_COLONY,
    TR_CITY_WARNING_BUILD_GLADIATOR_SCHOOL,
    TR_CITY_WARNING_BUILD_LION_HOUSE,
    TR_CITY_WARNING_BUILD_CHARIOT_MAKER,
    TR_CITY_WARNING_WALL_NEEDED,
    TR_CITY_WARNING_ENEMY_NEARBY,
    TR_CITY_WARNING_LEGION_MORALE_TOO_LOW,
    TR_CITY_WARNING_MAX_LEGIONS_REACHED,
    TR_CITY_WARNING_PEOPLE_ON_BRIDGE,
    TR_CITY_WARNING_DOCK_OPEN_WATER_NEEDED,
    TR_CITY_WARNING_EDITOR_NEED_MAP_EDGE,
    TR_CITY_WARNING_EDITOR_NEED_OPEN_WATER,
    TR_CITY_WARNING_EDITOR_CANNOT_PLACE,
    TR_CITY_WARNING_EDITOR_NO_EARTHQUAKE_SCHEDULED,
    TR_CITY_WARNING_HOUSE_TOO_FAR_FROM_ROAD,
    TR_CITY_WARNING_CITY_BOXED_IN,
    TR_CITY_WARNING_CITY_BOXED_IN_PEOPLE_WILL_PERISH,
    TR_CITY_WARNING_DATA_LIMIT_REACHED,
    TR_CITY_WARNING_TEMPLATE_MISSING_RESOURCE,
    TR_CITY_WARNING_TEMPLATE_MISSING_PRODUCER,
    TR_CITY_WARNING_TEMPLATE_BUILDING_NEEDS_RESOURCE,
    TR_CITY_WARNING_TEMPLATE_BUILDING_NEEDS_MATERIALS,
    TR_CITY_WARNING_TEMPLATE_BUILDING_NEEDS_BUILDING,
    TR_CITY_WARNING_TEMPLATE_ONE_BUILDING_OF_TYPE,
