...
typedef struct {
    ...
    int queried_bucket_going_has_path;
    int queried_bucket_going_sample_offset;
    int queried_bucket_at_fire_has_path;
    int queried_bucket_at_fire_sample_offset;
    int queried_ballista_idle_has_path;
    int queried_ballista_idle_sample_offset;
    int queried_ballista_firing_has_path;
    ...
    int queried_resource_cart_empty_has_path;
    ...
    int queried_directional_has_path;
