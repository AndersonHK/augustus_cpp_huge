...
static void draw_foreground(void)
{
    ...
    lang_text_draw(44, 88, 32, 17, FONT_LARGE_BLACK, screen_ui_to_pixel(font_definition_for(FONT_LARGE_BLACK)->line_height));
    lang_text_draw_centered(13, 3, 12, 452, 480, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));

    lang_text_draw(44, 108, 32, 57, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 89, 32, 137, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 39, 32, 177, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 68, 32, 217, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 43, 32, 257, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    button_border_draw(262, 248, 200, 30, data.focus_button_id == 6);
    lang_text_draw_centered(18, scenario_property_rome_supplies_wheat(), 262, 257, 200, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));

    lang_text_draw(44, 80, 32, 297, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    button_border_draw(262, 288, 200, 30, data.focus_button_id == 7);
    lang_text_draw_centered(18, scenario_map_has_flotsam(), 262, 297, 200, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));

    lang_text_draw(44, 91, 32, 337, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 92, 32, 377, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    ...
    lang_text_draw(44, 93, 32, 417, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
...
{
    if (GenericButton::handle_mouse(*mouse_in_dialog(m), 0, 0, buttons, 10, &data.focus_button_id)) {
        return;
    }
