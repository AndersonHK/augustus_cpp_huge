...
static void draw_foreground(void)
{
    ...
    lang_text_draw_centered("TR_EDITOR_SCENARIO_SELECT_CONDITION", 35, 30, BUTTON_WIDTH, FONT_LARGE_BLACK, screen_ui_to_pixel(font_definition_for(FONT_LARGE_BLACK)->line_height));
