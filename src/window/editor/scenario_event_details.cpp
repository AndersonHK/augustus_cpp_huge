...
static void handle_input(const mouse *m, const hotkeys *h)
{
    ...
    if (input_box_handle_mouse(m_dialog, &event_name_input) ||
        GenericButton::handle_mouse(*m_dialog, 0, 0, top_buttons, NUM_TOP_BUTTONS, &data.focus_button.top) ||
        GenericButton::handle_mouse(*m_dialog, 0, 0, select_all_none_buttons, 2, &data.focus_button.select_all_none) ||
        GenericButton::handle_mouse(*m_dialog, 0, 0, bottom_buttons, NUM_BOTTOM_BUTTONS, &data.focus_button.bottom) ||
