...
static void draw_foreground(void)
{
    ...
    lang_text_draw("main_strings.13.5", 352, 256, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
    lang_text_draw("main_strings.12.0", 200, 256, FONT_NORMAL_BLACK, screen_ui_to_pixel(font_definition_for(FONT_NORMAL_BLACK)->line_height));
