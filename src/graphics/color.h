...
#define COLOR_OVERLAY_RED 0x80ff0818
#define COLOR_OVERLAY_GREEN 0x8018ff18
#define COLOR_OVERLAY_HOVER 0x2d000000
...
#define COLOR_MASK_YELLOW_RANGE 0x40e7e75a      //25% transparent font yellow
