...
{
    static std::array<scenario_condition_data_t, CONDITION_TYPE_MAX> data{};
    ...
    if (!initialized) {
        ...
        data[CONDITION_TYPE_MONEY] = scenario_condition_data_t{.type = CONDITION_TYPE_MONEY,
        ...
        data[CONDITION_TYPE_SAVINGS] = scenario_condition_data_t{.type = CONDITION_TYPE_SAVINGS,
        ...
        data[CONDITION_TYPE_STATS_FAVOR] = scenario_condition_data_t{.type = CONDITION_TYPE_STATS_FAVOR,
        ...
        data[CONDITION_TYPE_STATS_PROSPERITY] = scenario_condition_data_t{.type = CONDITION_TYPE_STATS_PROSPERITY,
                                        .xml_attr = {.name = "stats_prosperity",     .type = PARAMETER_TYPE_TEXT,       .key = "TR_CONDITION_TYPE_STATS_PROSPERITY" },
                                        .xml_parm1 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,     .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm2 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = 100,   .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_STATS_CULTURE] = scenario_condition_data_t{.type = CONDITION_TYPE_STATS_CULTURE,
                                        .xml_attr = {.name = "stats_culture",        .type = PARAMETER_TYPE_TEXT,       .key = "TR_CONDITION_TYPE_STATS_CULTURE" },
                                        .xml_parm1 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,     .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm2 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = 100,   .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_STATS_PEACE] = scenario_condition_data_t{.type = CONDITION_TYPE_STATS_PEACE,
                                        .xml_attr = {.name = "stats_peace",          .type = PARAMETER_TYPE_TEXT,       .key = "TR_CONDITION_TYPE_STATS_PEACE" },
                                        .xml_parm1 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,     .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm2 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = 100,   .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_TRADE_SELL_PRICE] = scenario_condition_data_t{.type = CONDITION_TYPE_TRADE_SELL_PRICE,
        ...
        data[CONDITION_TYPE_POPS_UNEMPLOYMENT] = scenario_condition_data_t{.type = CONDITION_TYPE_POPS_UNEMPLOYMENT,
                                        ...
                                        .xml_parm2 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,             .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm3 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_ROME_WAGES] = scenario_condition_data_t{.type = CONDITION_TYPE_ROME_WAGES,
        ...
        data[CONDITION_TYPE_CITY_POPULATION] = scenario_condition_data_t{.type = CONDITION_TYPE_CITY_POPULATION,
        ...
        data[CONDITION_TYPE_BUILDING_COUNT_ACTIVE] = scenario_condition_data_t{.type = CONDITION_TYPE_BUILDING_COUNT_ACTIVE,
        ...
        data[CONDITION_TYPE_STATS_CITY_HEALTH] = scenario_condition_data_t{.type = CONDITION_TYPE_STATS_CITY_HEALTH,
                                        .xml_attr = {.name = "stats_health",          .type = PARAMETER_TYPE_TEXT,      .key = "TR_CONDITION_TYPE_STATS_CITY_HEALTH" },
                                        .xml_parm1 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,       .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm2 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = 100,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_COUNT_OWN_TROOPS] = scenario_condition_data_t{.type = CONDITION_TYPE_COUNT_OWN_TROOPS,
        ...
        data[CONDITION_TYPE_REQUEST_IS_ONGOING] = scenario_condition_data_t{.type = CONDITION_TYPE_REQUEST_IS_ONGOING,
        ...
        data[CONDITION_TYPE_TAX_RATE] = scenario_condition_data_t{.type = CONDITION_TYPE_TAX_RATE,
        ...
        data[CONDITION_TYPE_BUILDING_COUNT_ANY] = scenario_condition_data_t{.type = CONDITION_TYPE_BUILDING_COUNT_ANY,
                                        .xml_attr = {.name = "building_count_any",     .type = PARAMETER_TYPE_TEXT,  .key = "TR_CONDITION_TYPE_BUILDING_COUNT_ANY" },
                                        .xml_parm1 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,             .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm2 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_FORMULA" },
                                        .xml_parm3 = {.name = "building",       .type = PARAMETER_TYPE_BUILDING_COUNTING,                        .key = "TR_PARAMETER_TYPE_BUILDING_COUNTING" }, };
        data[CONDITION_TYPE_CUSTOM_VARIABLE_CHECK] = scenario_condition_data_t{.type = CONDITION_TYPE_CUSTOM_VARIABLE_CHECK,
        ...
        data[CONDITION_TYPE_TRADE_ROUTE_OPEN] = scenario_condition_data_t{.type = CONDITION_TYPE_TRADE_ROUTE_OPEN,
        ...
        data[CONDITION_TYPE_TRADE_ROUTE_PRICE] = scenario_condition_data_t{.type = CONDITION_TYPE_TRADE_ROUTE_PRICE,
                                        .xml_attr = {.name = "trade_route_price",    .type = PARAMETER_TYPE_TEXT,       .key = "TR_CONDITION_TYPE_TRADE_ROUTE_PRICE" },
                                        .xml_parm1 = {.name = "target_city",    .type = PARAMETER_TYPE_ROUTE,            .key = "TR_PARAMETER_TYPE_ROUTE" },
                                        .xml_parm2 = {.name = "check",          .type = PARAMETER_TYPE_CHECK,            .min_limit = 1,         .max_limit = 6,             .key = "TR_PARAMETER_TYPE_CHECK" },
                                        .xml_parm3 = {.name = "value",          .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,         .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[CONDITION_TYPE_RESOURCE_STORED_COUNT] = scenario_condition_data_t{.type = CONDITION_TYPE_RESOURCE_STORED_COUNT,
        ...
        data[CONDITION_TYPE_RESOURCE_STORAGE_AVAILABLE] = scenario_condition_data_t{.type = CONDITION_TYPE_RESOURCE_STORAGE_AVAILABLE,
        ...
        data[CONDITION_TYPE_BUILDING_COUNT_AREA] = scenario_condition_data_t{.type = CONDITION_TYPE_BUILDING_COUNT_AREA,
        ...
        data[CONDITION_TYPE_CHECK_FORMULA] = scenario_condition_data_t{.type = CONDITION_TYPE_CHECK_FORMULA,
        ...
        data[CONDITION_TYPE_TERRAIN_IN_AREA] = scenario_condition_data_t{.type = CONDITION_TYPE_TERRAIN_IN_AREA,
...
{
    return &scenario_condition_data_table()[type];
}

static std::array<scenario_action_data_t, ACTION_TYPE_MAX> &scenario_action_data_table()
{
    static std::array<scenario_action_data_t, ACTION_TYPE_MAX> data{};
    static int initialized = 0;
    if (!initialized) {
        data[ACTION_TYPE_ADJUST_FAVOR] = scenario_action_data_t{.type = ACTION_TYPE_ADJUST_FAVOR,
        ...
        data[ACTION_TYPE_ADJUST_MONEY] = scenario_action_data_t{.type = ACTION_TYPE_ADJUST_MONEY,
                                        .xml_attr = {.name = "money_add",          .type = PARAMETER_TYPE_TEXT,     .key = "TR_ACTION_TYPE_ADJUST_MONEY" },
                                        .xml_parm1 = {.name = "formula" ,        .type = PARAMETER_TYPE_FORMULA,        .min_limit = NEGATIVE_UNLIMITED,      .max_limit = UNLIMITED,      .key = "TR_PARAMETER_TYPE_FORMULA" },};
        data[ACTION_TYPE_ADJUST_SAVINGS] = scenario_action_data_t{.type = ACTION_TYPE_ADJUST_SAVINGS,
                                        .xml_attr = {.name = "savings_add",        .type = PARAMETER_TYPE_TEXT,     .key = "TR_ACTION_TYPE_ADJUST_SAVINGS" },
                                        .xml_parm1 = {.name = "formula" ,        .type = PARAMETER_TYPE_FORMULA,      .min_limit = NEGATIVE_UNLIMITED,      .max_limit = UNLIMITED,        .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[ACTION_TYPE_TRADE_ADJUST_PRICE] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_ADJUST_PRICE,
        ...
        data[ACTION_TYPE_TRADE_PROBLEM_LAND] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_PROBLEM_LAND,
        ...
        data[ACTION_TYPE_TRADE_PROBLEM_SEA] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_PROBLEM_SEA,
                                        .xml_attr = {.name = "trade_problems_sea",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_TRADE_PROBLEM_SEA" },
                                        .xml_parm1 = {.name = "duration",       .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,      .max_limit = 10000,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[ACTION_TYPE_TRADE_ADJUST_ROUTE_AMOUNT] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_ADJUST_ROUTE_AMOUNT,
        ...
        data[ACTION_TYPE_ADJUST_ROME_WAGES] = scenario_action_data_t{.type = ACTION_TYPE_ADJUST_ROME_WAGES,
        ...
        data[ACTION_TYPE_GLADIATOR_REVOLT] = scenario_action_data_t{.type = ACTION_TYPE_GLADIATOR_REVOLT,
                                        .xml_attr = {.name = "gladiator_revolt",     .type = PARAMETER_TYPE_TEXT,       .key = "TR_ACTION_TYPE_GLADIATOR_REVOLT" }, };
        data[ACTION_TYPE_CHANGE_RESOURCE_PRODUCED] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_RESOURCE_PRODUCED,
        ...
        data[ACTION_TYPE_CHANGE_ALLOWED_BUILDINGS] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_ALLOWED_BUILDINGS,
        ...
        data[ACTION_TYPE_SEND_STANDARD_MESSAGE] = scenario_action_data_t{.type = ACTION_TYPE_SEND_STANDARD_MESSAGE,
        ...
        data[ACTION_TYPE_ADJUST_CITY_HEALTH] = scenario_action_data_t{.type = ACTION_TYPE_ADJUST_CITY_HEALTH,
                                        ...
                                        .xml_parm2 = {.name = "set_to_value",   .type = PARAMETER_TYPE_BOOLEAN,          .min_limit = 0,      .max_limit = 1,          .key = "TR_PARAMETER_SET_TO_VALUE" },};
        data[ACTION_TYPE_TRADE_SET_PRICE] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_SET_PRICE,
                                        ...
                                        .xml_parm4 = {.name = "show_message",   .type = PARAMETER_TYPE_BOOLEAN,          .min_limit = 0,           .max_limit = 1,      .key = "TR_PARAMETER_SHOW_MESSAGE" }, };
        data[ACTION_TYPE_EMPIRE_MAP_CONVERT_FUTURE_TRADE_CITY] = scenario_action_data_t{.type = ACTION_TYPE_EMPIRE_MAP_CONVERT_FUTURE_TRADE_CITY,
        ...
        data[ACTION_TYPE_REQUEST_IMMEDIATELY_START] = scenario_action_data_t{.type = ACTION_TYPE_REQUEST_IMMEDIATELY_START,
                                        .xml_attr = {.name = "request_immediately_start",     .type = PARAMETER_TYPE_TEXT,     .key = "TR_ACTION_TYPE_REQUEST_IMMEDIATELY_START" },
                                        .xml_parm1 = {.name = "request_id",     .type = PARAMETER_TYPE_REQUEST,           .min_limit = 0,           .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_REQUEST" }, };
        data[ACTION_TYPE_SHOW_CUSTOM_MESSAGE] = scenario_action_data_t{.type = ACTION_TYPE_SHOW_CUSTOM_MESSAGE,
        ...
        data[ACTION_TYPE_TAX_RATE_SET] = scenario_action_data_t{.type = ACTION_TYPE_TAX_RATE_SET,
        ...
        data[ACTION_TYPE_CHANGE_CUSTOM_VARIABLE] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_CUSTOM_VARIABLE,
        ...
        data[ACTION_TYPE_TRADE_ADJUST_ROUTE_OPEN_PRICE] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_ADJUST_ROUTE_OPEN_PRICE,
                                        ...
                                        .xml_parm3 = {.name = "set_to_value",   .type = PARAMETER_TYPE_BOOLEAN,          .min_limit = 0,      .max_limit = 1,      .key = "TR_PARAMETER_SET_TO_VALUE" },
                                        .xml_parm4 = {.name = "show_message",   .type = PARAMETER_TYPE_BOOLEAN,          .min_limit = 0,      .max_limit = 1,      .key = "TR_PARAMETER_SHOW_MESSAGE" }, };
        data[ACTION_TYPE_CHANGE_CITY_RATING] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_CITY_RATING,
                                        ...
                                        .xml_parm3 = {.name = "set_to_value",   .type = PARAMETER_TYPE_BOOLEAN,          .min_limit = 0,           .max_limit = 1,      .key = "TR_PARAMETER_SET_TO_VALUE" }, };
        data[ACTION_TYPE_CHANGE_RESOURCE_STOCKPILES] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_RESOURCE_STOCKPILES,
        ...
        data[ACTION_TYPE_TRADE_ROUTE_SET_OPEN] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_ROUTE_SET_OPEN,
        ...
        data[ACTION_TYPE_TRADE_ROUTE_ADD_NEW_RESOURCE] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_ROUTE_ADD_NEW_RESOURCE,
        ...
        data[ACTION_TYPE_TRADE_SET_BUY_PRICE_ONLY] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_SET_BUY_PRICE_ONLY,
                                        .xml_attr = {.name = "trade_set_buy_price_only",    .type = PARAMETER_TYPE_TEXT,         .key = "TR_ACTION_TYPE_TRADE_SET_BUY_PRICE_ONLY" },
                                        .xml_parm1 = {.name = "resource",       .type = PARAMETER_TYPE_RESOURCE,         .key = "TR_PARAMETER_TYPE_RESOURCE" },
                                        .xml_parm2 = {.name = "amount",         .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,           .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[ACTION_TYPE_TRADE_SET_SELL_PRICE_ONLY] = scenario_action_data_t{.type = ACTION_TYPE_TRADE_SET_SELL_PRICE_ONLY,
                                        .xml_attr = {.name = "trade_set_sell_price_only",    .type = PARAMETER_TYPE_TEXT,         .key = "TR_ACTION_TYPE_TRADE_SET_SELL_PRICE_ONLY" },
                                        .xml_parm1 = {.name = "resource",       .type = PARAMETER_TYPE_RESOURCE,         .key = "TR_PARAMETER_TYPE_RESOURCE" },
                                        .xml_parm2 = {.name = "amount",         .type = PARAMETER_TYPE_FORMULA,           .min_limit = 0,           .max_limit = UNLIMITED,     .key = "TR_PARAMETER_TYPE_FORMULA" }, };
        data[ACTION_TYPE_BUILDING_FORCE_COLLAPSE] = scenario_action_data_t{.type = ACTION_TYPE_BUILDING_FORCE_COLLAPSE,
        ...
        data[ACTION_TYPE_INVASION_IMMEDIATE] = scenario_action_data_t{.type = ACTION_TYPE_INVASION_IMMEDIATE,
        ...
        data[ACTION_TYPE_CAUSE_BLESSING] = scenario_action_data_t{.type = ACTION_TYPE_CAUSE_BLESSING,
        ...
        data[ACTION_TYPE_CAUSE_MINOR_CURSE] = scenario_action_data_t{.type = ACTION_TYPE_CAUSE_MINOR_CURSE,
                                        .xml_attr = {.name = "cause_minor_curse",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_CAUSE_MINOR_CURSE" },
                                        .xml_parm1 = {.name = "god",                 .type = PARAMETER_TYPE_GOD,       .key = "TR_PARAMETER_TYPE_GOD" }, };
        data[ACTION_TYPE_CAUSE_MAJOR_CURSE] = scenario_action_data_t{.type = ACTION_TYPE_CAUSE_MAJOR_CURSE,
                                        .xml_attr = {.name = "cause_major_curse",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_CAUSE_MAJOR_CURSE" },
                                        .xml_parm1 = {.name = "god",                 .type = PARAMETER_TYPE_GOD,       .key = "TR_PARAMETER_TYPE_GOD" }, };
        data[ACTION_TYPE_CHANGE_CLIMATE] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_CLIMATE,
        ...
        data[ACTION_TYPE_CHANGE_TERRAIN] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_TERRAIN,
        ...
        data[ACTION_TYPE_CHANGE_MODEL_DATA] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_MODEL_DATA,
        ...
        data[ACTION_TYPE_CHANGE_CUSTOM_VARIABLE_VISIBILITY] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_CUSTOM_VARIABLE_VISIBILITY,
        ...
        data[ACTION_TYPE_CUSTOM_VARIABLE_FORMULA] = scenario_action_data_t{.type = ACTION_TYPE_CUSTOM_VARIABLE_FORMULA,
        ...
        data[ACTION_TYPE_CUSTOM_VARIABLE_CITY_PROPERTY] = scenario_action_data_t{.type = ACTION_TYPE_CUSTOM_VARIABLE_CITY_PROPERTY,
        ...
        data[ACTION_TYPE_GOD_SENTIMENT_CHANGE] = scenario_action_data_t{.type = ACTION_TYPE_GOD_SENTIMENT_CHANGE,
                                        .xml_attr = {.name = "change_god_sentiment",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_GOD_SENTIMENT" },
                                        .xml_parm1 = {.name = "god",                 .type = PARAMETER_TYPE_GOD,       .key = "TR_PARAMETER_TYPE_GOD" },
                                        .xml_parm2 = {.name = "amount",              .type = PARAMETER_TYPE_FORMULA,  .min_limit = -100,        .max_limit = 100,     .key = "TR_PARAMETER_TYPE_FORMULA" },
                                        .xml_parm3 = {.name = "set_to_value",        .type = PARAMETER_TYPE_BOOLEAN,  .min_limit = 0,        .max_limit = 1,       .key = "TR_PARAMETER_SET_TO_VALUE" }, };
        data[ACTION_TYPE_POP_SENTIMENT_CHANGE] = scenario_action_data_t{.type = ACTION_TYPE_POP_SENTIMENT_CHANGE,
                                        .xml_attr = {.name = "change_pop_sentiment",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_POP_SENTIMENT"},
                                        .xml_parm1 = {.name = "amount",              .type = PARAMETER_TYPE_FORMULA,  .min_limit = -100,     .max_limit = 100,     .key = "TR_PARAMETER_TYPE_FORMULA" },
                                        .xml_parm2 = {.name = "set_to_value",        .type = PARAMETER_TYPE_BOOLEAN,  .min_limit = 0,        .max_limit = 1,       .key = "TR_PARAMETER_SET_TO_VALUE" }, };
        data[ACTION_TYPE_WIN] = scenario_action_data_t{.type = ACTION_TYPE_WIN,
                                        .xml_attr = {.name = "win",    .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_WIN" }, };
        data[ACTION_TYPE_LOSE] = scenario_action_data_t{.type = ACTION_TYPE_LOSE,
                                        .xml_attr = {.name = "lose",   .type = PARAMETER_TYPE_TEXT,      .key = "TR_ACTION_TYPE_LOSE" }, };
        data[ACTION_TYPE_CHANGE_RANK] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_RANK,
        ...
        data[ACTION_TYPE_CHANGE_PRODUCTION_RATE] = scenario_action_data_t{.type = ACTION_TYPE_CHANGE_PRODUCTION_RATE,
        ...
        data[ACTION_TYPE_LOCK_TRADE_ROUTE] = scenario_action_data_t{.type = ACTION_TYPE_LOCK_TRADE_ROUTE,
...
{
    return &scenario_action_data_table()[type];
}
    ...
    action_types action_type, int parameter_index, int *min_limit, int *max_limit)
{
    ...
    const scenario_action_data_t *action = &scenario_action_data_table()[action_type];
    ...
    condition_types condition_type, int parameter_index, int *min_limit, int *max_limit)
{
    ...
    const scenario_condition_data_t *condition = &scenario_condition_data_table()[condition_type];
...
void scenario_events_parameter_data_sort_alphabetically(void)
{
    ...
    for (int i = 1; i < CONDITION_TYPE_MAX; i++) {
        conditions[i - 1].type = scenario_condition_data_table()[i].type;
        conditions[i - 1].key = scenario_condition_data_table()[i].xml_attr.key;
    }
    for (int i = 1; i < ACTION_TYPE_MAX; i++) {
        actions[i - 1].type = scenario_action_data_table()[i].type;
        actions[i - 1].key = scenario_action_data_table()[i].xml_attr.key;
    }
    ...
    for (int i = 0; i < CONDITION_TYPE_MAX - 1; i++) {
        scenario_condition_data_alphabetical[i] =
            scenario_events_parameter_data_get_conditions_xml_attributes(static_cast<condition_types>(conditions[i].type));
    }
    for (int i = 0; i < ACTION_TYPE_MAX - 1; i++) {
        scenario_action_data_alphabetical[i] =
            scenario_events_parameter_data_get_actions_xml_attributes(static_cast<action_types>(actions[i].type));
    }
}
...
static special_attribute_mapping_t make_mapping(parameter_type type, const char *text, int value, translation_key key)
{
    special_attribute_mapping_t mapping{};
    mapping.type = type;
    mapping.text = text;
    mapping.value = value;
    mapping.key = key;
...
static void generate_submenu_mappings(build_menu_group menu)
{
    ...
    for (unsigned int i = 0; i < menu_items; i++) {
        ...
        build_menu_group submenu = static_cast<build_menu_group>(building_menu_get_submenu_for_type(type));
        if (submenu) {
            if (submenu == menu) {
                continue;
            }
...
static void generate_allowed_buildings_mappings(void)
{
    ...
    for (int group = 0; group < BUILD_MENU_MAX; group++) {
        build_menu_group menu_group = static_cast<build_menu_group>(group);
        // Top level function: main menus only
        if (building_menu_is_submenu(menu_group)) {
            break;
        }
        generate_submenu_mappings(menu_group);
    }
}
...
parameter_type scenario_events_parameter_data_resolve_flexible_type(const scenario_action_t *action, int param_number)
{
    ...
    city_property_t city_property = static_cast<city_property_t>(action->parameter2);
...
static uint8_t *translation_for_request_value(int value, uint8_t *result_text, int *maxlength)
{
    if (value < 0 || value >= (int) scenario_request_count_total()) {
        return string_copy(translation_for_key("TR_PARAMETER_VALUE_NONE"), result_text, *maxlength);
    }
    ...
    switch (type) {
        ...
        case PARAMETER_TYPE_ROUTE_RESOURCE:
        {
            if ((RESOURCE_NONE + 1) < value && value < RESOURCE_SLOT_COUNT) {
                result_text = string_copy(translation_for_key("TR_PARAMETER_VALUE_NONE"), result_text, maxlength);
                return;
            }
...
static uint8_t *translation_for_set_or_add_text(int parameter, uint8_t *result_text, int *maxlength)
{
    ...
    if (parameter) {
        result_text = append_text(translation_for_key("TR_PARAMETER_DISPLAY_SET_TO"), result_text, maxlength);
    } else {
    ...
    int maxlength)
{
    ...
    switch (action->type) {
        ...
        {
            result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
            result_text = append_text(translation_for_key("TR_PARAMETER_GRID_OFFSET_CORNER1"), result_text, &maxlength);
            ...
            if (action->parameter4) {
                result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
                result_text = append_text(translation_for_key("TR_PARAMETER_DISPLAY_DESTROY_ALL_TYPES"), result_text, &maxlength);
            } else {
        ...
        case ACTION_TYPE_INVASION_IMMEDIATE:
        {
            ...
            result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
            result_text = append_text(translation_for_key("TR_PARAMETER_TYPE_INVASION_SIZE"), result_text, &maxlength);
            result_text = translation_for_formula_index(action->parameter2, result_text, &maxlength);
            result_text = translation_for_type_lookup_by_value(PARAMETER_TYPE_ENEMY_TYPE, action->parameter5, result_text, &maxlength);
            result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
            result_text = append_text(translation_for_key("TR_PARAMETER_TYPE_INVASION_POINT"), result_text, &maxlength);
        ...
        case ACTION_TYPE_TRADE_PROBLEM_SEA:
        {
            result_text = translation_for_formula_index(action->parameter1, result_text, &maxlength);
            result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
            result_text = append_text(translation_for_key("TR_PARAMETER_DISPLAY_DAYS"), result_text, &maxlength);
            return;
        }
        ...
        case ACTION_TYPE_CHANGE_MODEL_DATA:
        {
            ...
            result_text = append_text(string_from_ascii(" "), result_text, &maxlength);
            result_text = append_text(translation_for_key("TR_PARAMETER_OF"), result_text, &maxlength);
