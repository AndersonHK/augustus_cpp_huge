...
{
    switch (condition->type) {
        case CONDITION_TYPE_POPULATION_IN_AREA: return scenario_condition_type_population_in_area_met(condition);
        ...
        case CONDITION_TYPE_ENEMIES_IN_CITY: return scenario_condition_type_count_enemies_in_city_met(condition);
        case CONDITION_TYPE_LAND_TRADE_PROBLEMS: return scenario_condition_type_land_trade_problems_met(condition);
        case CONDITION_TYPE_SEA_TRADE_PROBLEMS: return scenario_condition_type_sea_trade_problems_met(condition);
        case CONDITION_TYPE_MONTHS_SINCE_FESTIVAL: return scenario_condition_type_months_since_last_festival_met(condition);
        case CONDITION_TYPE_DESIRABILITY_IN_AREA: return scenario_condition_type_desirability_in_area_met(condition);
        case CONDITION_TYPE_FIGURES_IN_AREA: return scenario_condition_type_figures_in_area_met(condition);
        default:
