...
static int xml_start_media(void)
{
    ...
    data.current_message->linked_media[found->value] = custom_media_create(static_cast<custom_media_type>(found->value),
...
static int xml_start_background_music(void)
{
    ...
    data.current_message->linked_background_music = custom_media_create(CUSTOM_MEDIA_SOUND, string_from_ascii(media_filename),
