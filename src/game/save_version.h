...
typedef enum {
    ...
    SAVE_GAME_LAST_NO_MONUMENT_GIFTS = 0xc7,
    ...
    SAVE_GAME_LAST_FIXED_FORMATION_ROSTER = 0xbb,
    SAVE_GAME_LAST_NO_MINIMAP_PREVIEW_BITMAP = 0xbc,
    SAVE_GAME_LAST_RUBBLE_ORIGIN_GRID_OFFSET = 0xbd,
    SAVE_GAME_LAST_RUBBLE_ORIGIN_RECTANGLE = 0xbe,
    SAVE_GAME_LAST_NO_FOUNDATION_TERRAIN_DELTAS = 0xbf,
    SAVE_GAME_LAST_LEGACY_FIGURE_MOVEMENT_GRAIN = 0xc0,
    SAVE_GAME_LAST_NO_NATIVE_SURFACE_BUILDING_RECORDS = 0xc1,
    SAVE_GAME_LAST_NO_EXACT_FIGURE_PROFILE_IDENTITY = 0xc2,
    SAVE_GAME_LAST_NO_STRICT_NATIVE_BRIDGE_WALL_RECORDS = 0xc2,
    SAVE_GAME_LAST_UNVERIFIED_NATIVE_SURFACE_RECORDS = 0xc3,
    SAVE_GAME_LAST_UNVERIFIED_FIGURE_OWNER_REFERENCES = 0xc3,
    SAVE_GAME_LAST_DELAYED_FIGURE_OWNER_BINDING = 0xc4,
    SAVE_GAME_LAST_UNNOTIFIED_RUNTIME_RELATIONSHIPS = 0xc5,
    SAVE_GAME_LAST_NO_FIGURE_TYPE_IDENTITY = 0xc6
} savegame_version_t;
