...
void building_type_id_bridge_save_table_load_state(buffer *buf, int has_save_table, savegame_version_t save_version);
void building_type_id_bridge_save_table_preview_load_state(buffer *buf, int has_save_table, savegame_version_t save_version);
void building_type_id_bridge_save_table_preview_restore(void);
