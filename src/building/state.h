...
#define BUILDING_STATE_NONSTATIC_RESOURCE_SIZE (RESOURCE_SLOT_COUNT * 3)
...
#define BUILDING_STATE_WITHOUT_RESOURCES (BUILDING_STATE_SICKNESS - resource_id_bridge_legacy_resource_count()) // 126 (plus variable resource size)
