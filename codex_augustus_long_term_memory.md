...
- Save/load runtime bridge notes live in `docs/save_load_runtime_bridges.md`; check that before changing BuildingType save ids, the `0xb6` owned building save heap, monument construction loading, road service history, local workforce allocations, or runtime wrapper rebinding.
